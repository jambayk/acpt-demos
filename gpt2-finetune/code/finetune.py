...
def main(model_path: str, tokenizer_path: str, config_path: str, 
         ...
         ort: bool, fp16: bool, deepspeed: bool):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_path", type=str, default="data/training_raw.txt",
                        help="Pre-processed training data")
    parser.add_argument("--validation_path", type=str, default="data/validation_raw.txt",
                        help="Pre-processed validation data")
